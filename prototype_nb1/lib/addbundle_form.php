...
class addbundle_form extends nbform
{
	...
	function getHtml()
	{
		...
		$out .= $this->textareaInput('What teaching problem does this address?', 'problemstatement', $this->problemstatement, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('Description', 'thisbundle', $this->thisbundle, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('How it works', 'wayitworks', $this->wayitworks, $this->validateMessages, 70 , 8);
