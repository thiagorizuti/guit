...
class addbundle_form extends nbform
{
	...
	function getHtml()
	{
		...
		$out .= $this->textareaInput('Keywords:', 'problemstatement', $this->problemstatement, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('Why this practice should be adopted ?', 'thisbundle', $this->thisbundle, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('This bundle:', 'wayitworks', $this->wayitworks, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('What we did:', 'worksbetter', $this->worksbetter, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('This only works if...', 'doesntwork', $this->doesntwork, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('This works better if...', 'doesntworkunless', $this->doesntworkunless, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('This works best if...', 'workedif', $this->workedif, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('This doesn’t work unless...', 'variations', $this->variations, $this->validateMessages, 70 , 8);
		$out .= $this->textareaInput('So:', 'solutionstatement', $this->solutionstatement, $this->validateMessages, 70 , 8);
